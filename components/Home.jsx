...
function MyApp() {
  const [products] = useState([
    ...
    { id: 11, name: 'soaps', image: soaps, price: 398 },
    { id: 11, name: 'Sugar', image: Sugar, price: 398 },
    { id: 11, name: 'oil', image: oil, price: 398 },
    { id: 11, name: 'facewash', image: facewash, price: 398 },
  ...
  const [otherProducts] = useState([
    ...
    { id: 10, name: 'Vim', image: Vim, price: 20},
    { id: 11, name: 'Surf', image: Surf, price: 40 },
        ...
        <div class="row">
          ...
          <div className="d-flex align-items-center"/>
            ...
            <p>India AndhraPradesh
              <br/>Sattenaplle,palnadu district
            </p>
          </div>
